...
{
    public class EfInvoiceRepository : EfEntityRepositoryBase<Invoice, InvoiceManagementDbContext>, IInvoiceRepository
    {
        public EfInvoiceRepository(InvoiceManagementDbContext context) : base(context)
        {
        }
