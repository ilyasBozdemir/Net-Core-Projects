...
{
    public class EfResidentRepository : EfEntityRepositoryBase<Resident, InvoiceManagementDbContext>, IResidentRepository
    {
        public EfResidentRepository(InvoiceManagementDbContext context) : base(context)
        {
        }
