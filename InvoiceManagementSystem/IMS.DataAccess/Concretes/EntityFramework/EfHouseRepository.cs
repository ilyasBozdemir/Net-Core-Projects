...
{
    public class EfHouseRepository : EfEntityRepositoryBase<House, InvoiceManagementDbContext>, IHouseRepository
    {
        public EfHouseRepository(InvoiceManagementDbContext context) : base(context)
        {
        }
