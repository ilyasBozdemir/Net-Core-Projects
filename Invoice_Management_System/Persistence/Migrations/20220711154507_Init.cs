    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "BirthDay", "CitizenId", "ConcurrencyStamp", "CreatedOn", "Email", "EmailConfirmed", "FirstName", "Gender", "IsActive", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PasswordSalt", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "TwoFactorType", "UserName" },
                values: new object[] { new Guid("be175bf2-9a15-4708-89b4-15b57f3bfeda"), 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "bozdemir.ib70@gmail.com", true, "ilyas", 0, true, "Bozdemir", false, null, "BOZDEMIR.IB70@GMAIL.COM", "BOZDEMIR.ILYAS", "Rf*?b Y?????L\\1?????????-z2???_	k??'??????y1J????g(??&???", "???<???? ??k<?K????????l?H???(???(?i????t?(Bz+?????%(s?s???? ?????tG?_????I????4:?}R???????=X???X?V|?\"????`,?)\r0_?7", "+905464667898", true, "c31d085d-5293-444b-9914-7cf81573d472", false, 0, "Bozdemir.ilyas" });

            migrationBuilder.InsertData(
                table: "IdentityRole",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "979488cb-5c01-4c55-9a18-30f71b5acf35", "7df689f9-7c4f-48be-a098-e737a1db4524", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { new Guid("979488cb-5c01-4c55-9a18-30f71b5acf35"), new Guid("be175bf2-9a15-4708-89b4-15b57f3bfeda") });
