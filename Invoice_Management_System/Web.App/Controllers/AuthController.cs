...
namespace Web.App.Controllers
{
    public class AuthController : BaseController
    {
        ...
        public AuthController(UserManager<User> userManager, SignInManager<User> signInManager, EmailHelper emailHelper, TwoFactorAuthenticationService twoFactorAuthService)
        {
        ...
        public async Task<IActionResult> ExternalResponse(string ReturnUrl = "/")
        {
            ...
            if (existUser == null)
            {
                var user = new User { Email = externalEmail };
