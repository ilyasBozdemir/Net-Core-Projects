...
namespace Web.App.Controllers
{
    ...
    public class AuthController : BaseController
    {
        ...
        public AuthController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, EmailHelper emailHelper, TwoFactorAuthenticationService twoFactorAuthService)
        {
        ...
        public async Task<IActionResult> Login(SignInViewModel viewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var passwordHash = Encoding.ASCII.GetBytes(user.PasswordHash);

                var passwordSalt = Encoding.ASCII.GetBytes(user.PasswordSalt);

                var PasswordState =
                    HashingHelper.VerifyPasswordHash(viewModel.Password, passwordHash, passwordSalt);
                ...
                if (user != null)
                {
                    ...
                    else if (result.IsLockedOut)
                    {
                        ...
                        ModelState.AddModelError(string.Empty,
                            $"This account has been locked out, please try again {timeLeft.Minutes} minutes later.");
                    }
